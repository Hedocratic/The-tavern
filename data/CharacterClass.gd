...
static func get_all_classes() -> Array:
	...
	warrior.starting_stats = {
		"Strength": 12, "Fortitude": 12, "Agility": 10, 
		"Intelligence": 10, "Charisma": 10, "Arcane": 10
	}
	...
	thief.starting_stats = {
		"Strength": 10, "Fortitude": 10, "Agility": 12, 
		"Intelligence": 12, "Charisma": 10, "Arcane": 10
	}
	...
	assassin.starting_stats = {
		"Strength": 11, "Fortitude": 10, "Agility": 12, 
		"Intelligence": 11, "Charisma": 10, "Arcane": 10
	}
	...
	wizard.starting_stats = {
		"Strength": 10, "Fortitude": 10, "Agility": 10, 
		"Intelligence": 12, "Charisma": 10, "Arcane": 12
	}
	...
	cleric.starting_stats = {
		"Strength": 10, "Fortitude": 11, "Agility": 10, 
		"Intelligence": 11, "Charisma": 12, "Arcane": 12
	}
	...
	paladin.starting_stats = {
		"Strength": 11, "Fortitude": 12, "Agility": 10, 
		"Intelligence": 10, "Charisma": 12, "Arcane": 11
	}
	...
	barbarian.starting_stats = {
		"Strength": 12, "Fortitude": 12, "Agility": 11, 
		"Intelligence": 10, "Charisma": 10, "Arcane": 10
	}
	...
	druid.starting_stats = {
		"Strength": 10, "Fortitude": 11, "Agility": 11, 
		"Intelligence": 12, "Charisma": 10, "Arcane": 12
	}
	...
	monk.starting_stats = {
		"Strength": 11, "Fortitude": 11, "Agility": 12, 
		"Intelligence": 10, "Charisma": 11, "Arcane": 11
	}
